    ...
    screen: (
      <div className="flex flex-col h-full bg-gray-50">
        <div className="pt-14 px-4 pb-3 border-b border-gray-100 bg-white flex items-center justify-between">
          ...
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: "#2c76be" }}>+</div>
        </div>
        <div className="flex flex-col gap-2 p-3">
          {[
        ...
        <div className="flex flex-col gap-2 p-3">
          {[
            ...
            <div key={m.name} className="flex items-center gap-3 p-3 bg-white rounded-2xl shadow-sm border border-gray-100">
              <div className="w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0" style={{ backgroundColor: "#2c76be" }}>{m.initials}</div>
              <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-center p-2.5 rounded-2xl border-2 border-dashed border-gray-200 text-[10px] text-gray-400 font-medium mt-1">+ Üye Ekle</div>
        </div>
      </div>
    ),
  },
